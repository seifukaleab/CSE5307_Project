...
PreparedStatement pst;
    ...
    public viewWinner() {
       ...
       while(rs.next()){
            int win=rs.getInt("winnerLoto");
            String type=rs.getString("Type");
           int rr=rs.getInt("Rank");
        
DefaultTableModel model=null; 
int i=winnerTable.getRowCount();
for(int j=i-1;j>i;j--){
    model.removeRow(j);
}
model=(DefaultTableModel) winnerTable.getModel();
model.insertRow(model.getRowCount(),new Object[]{win,type,rr});   
    ...
    private void initComponents() {
        ...
        winnerTable.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        winnerTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Winner", "Type", "Prize Rank"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewWinner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewWinner().setVisible(true);
            }
        });
    }
